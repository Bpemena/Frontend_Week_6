        <div class="intro">
          <div class="intro__title"> <span>the </span>brand</div>
          <div class="intro__text">company slogan goes here</div>
          <div class="mobile">
            <div class="mobile-in">
              <div class="msearch">
                ...
                <div class="mmensmenu-in">
                  <div class="hmenu__menu">
                    <div class="hmenu__column">
                      <div class="hmenu__title">Casuals</div><a class="hmenu__link" href="#">Jackets</a><a class="hmenu__link" href="#">Hoodies & Sweatshirts</a><a class="hmenu__link" href="#">Polo Shirts</a><a class="hmenu__link" href="#">Sportswear</a><a class="hmenu__link" href="#">Trousers & Chinos</a><a class="hmenu__link" href="#">T-Shirts</a>
                    </div>
                    <div class="hmenu__column">
